...
export const players: Player[] = [
  ...
  // World Cup 2022 standout forwards
  { id: 15, name: 'Lautaro Martínez', shortName: 'MARTÍNEZ', club: 'Inter', country: 'ARG', position: 'FWD', overall: 87, stats: { pace: 84, shooting: 88, passing: 76, dribbling: 82, defending: 38, stamina: 85 }, accent: '#4a9fc9', floor: 2.1 },
  { id: 16, name: 'Julián Álvarez', shortName: 'ÁLVAREZ', club: 'Man City', country: 'ARG', position: 'FWD', overall: 86, stats: { pace: 86, shooting: 85, passing: 74, dribbling: 80, defending: 35, stamina: 88 }, accent: '#3da2d9', floor: 1.9 },
  { id: 17, name: 'Olivier Giroud', shortName: 'GIROUD', club: 'Milan', country: 'FRA', position: 'FWD', overall: 84, stats: { pace: 74, shooting: 82, passing: 78, dribbling: 72, defending: 38, stamina: 80 }, accent: '#1da1d9', floor: 1.8 },
  ...
  // World Cup 2022 standout midfielders
  { id: 18, name: 'Enzo Fernández', shortName: 'ENZO', club: 'Chelsea', country: 'ARG', position: 'MID', overall: 88, stats: { pace: 78, shooting: 78, passing: 86, dribbling: 85, defending: 72, stamina: 88 }, accent: '#3da2d9', floor: 2.7 },
  { id: 19, name: ' Alexis Mac Allister', shortName: 'MAC A.', club: 'Liverpool', country: 'ARG', position: 'MID', overall: 85, stats: { pace: 76, shooting: 74, passing: 82, dribbling: 84, defending: 75, stamina: 84 }, accent: '#4ab0e2', floor: 2.3 },
  { id: 20, name: 'Antoine Griezmann', shortName: 'GRIEZM.', club: 'Atlético', country: 'FRA', position: 'MID', overall: 86, stats: { pace: 72, shooting: 82, passing: 88, dribbling: 84, defending: 72, stamina: 82 }, accent: '#0078b6', floor: 2.2 },
  { id: 21, name: 'Aurélien Tchouaméni', shortName: 'TCH. ', club: 'Real Madrid', country: 'FRA', position: 'MID', overall: 86, stats: { pace: 78, shooting: 70, passing: 86, dribbling: 80, defending: 82, stamina: 86 }, accent: '#0077b3', floor: 2.8 },
  ...
  // World Cup 2022 standout defenders
  { id: 22, name: 'Marcos Acuña', shortName: 'ACUÑA', club: 'River', country: 'ARG', position: 'DEF', overall: 82, stats: { pace: 84, shooting: 58, passing: 78, dribbling: 74, defending: 78, stamina: 82 }, accent: '#2a8fc9', floor: 1.4 },
  { id: 23, name: 'Nahuel Molina', shortName: 'MOLINA', club: 'Atlético', country: 'ARG', position: 'DEF', overall: 83, stats: { pace: 86, shooting: 62, passing: 74, dribbling: 76, defending: 78, stamina: 84 }, accent: '#3da2d9', floor: 1.6 },
  { id: 24, name: 'Jules Koundé', shortName: 'KOUNDÉ', club: 'Barcelona', country: 'FRA', position: 'DEF', overall: 85, stats: { pace: 78, shooting: 55, passing: 84, dribbling: 81, defending: 85, stamina: 85 }, accent: '#0077b3', floor: 2.0 },
  { id: 25, name: 'Dayot Upamecano', shortName: 'UPAM.', club: 'Bayern', country: 'FRA', position: 'DEF', overall: 84, stats: { pace: 84, shooting: 52, passing: 76, dribbling: 72, defending: 85, stamina: 84 }, accent: '#0066a6', floor: 1.9 },
  ...
  // World Cup 2022 standout goalkeeper
  { id: 26, name: 'Emiliano Martínez', shortName: 'EMI', club: 'Aston Villa', country: 'ARG', position: 'GK', overall: 88, stats: { pace: 58, shooting: 22, passing: 82, dribbling: 58, defending: 92, stamina: 84 }, accent: '#3da2d9', floor: 1.7 },
]

// Fix: Need to update defaultSelection to use valid IDs (pick some WC stars)
// Keep existing default selection but it still works